...
export const PROFILE = {
  ...
  heroImage: '/Profile_portfolio.png',
};
...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    badge: 'Judges Choice',
    description:
      'Participated in a 12 hours hackathon competition for innovative solution development.',
    image: '/Hackathon.jpg',
  },
];
  ...
  courses: [
    {
      ...
      credits: null,
      icon: 'ml',
      description: 'Train, evaluate, and deploy predictive models for real-world products.',
    },
    {
      code: 'CSE 4883',
      ...
      credits: 3.0,
      icon: 'dip',
      description: 'Build vision pipelines — detection, segmentation, and feature extraction.',
    },
    {
      code: 'CSE 4891',
      title: 'Data Mining',
      credits: 3.0,
      icon: 'dm',
      description: 'Extract actionable patterns from large-scale data to drive decisions.',
    },
  ],
};
